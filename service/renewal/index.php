      ...
      <section class="sub__heading">
        <h1 class="sub__heading--text">
          <span class="sub__heading--textIn">
            <span class="font-en line-left">Renewal</span>
            <span class="font-mincho">基幹システム再構築</span>
          </span>
        </h1>
        <?php include($site_root . "_inc/headingAction.php"); ?>
        <div class="sub__headingImg"><img src="<?= $site_root; ?>assets/img/service/fullorder/heading.jpg" alt="基幹システム再構築"></div>
        ...
        <div class="l-column">
          ...
          <div class="sub__side l-column__sub">
            <div class="sub__side--in">
              ...
              <ul class="sub__side--list">
                <li class="sub__side--item js-nav"><a href="#onayami" class="js-anchor">このような課題はありませんか？</a></li>
                <li class="sub__side--item js-nav"><a href="#service" class="js-anchor">基幹システム再構築のサービス紹介</a></li>
                <li class="sub__side--item js-nav"><a href="#features" class="js-anchor">基幹システム再構築の特徴</a></li>
                <li class="sub__side--item js-nav"><a href="#support" class="js-anchor">基幹システム再構築のサポート体制</a></li>
                <li class="sub__side--item js-nav"><a href="#flow" class="js-anchor">基幹システム再構築の開発フロー</a></li>
                <li class="sub__side--item js-nav"><a href="#case" class="js-anchor">基幹システム再構築の開発事例</a></li>
                <li class="sub__side--item js-nav"><a href="#column" class="js-anchor">基幹システム再構築に関するコラム</a></li>
              </ul>
            </div>
          </div>
          <!--./l-column__sub-->
          ...
          <div class="l-column__main renewal">
            ...
            <section id="onayami" class="onayami l-section js-target">
              <div class="onayami__inner">
                <h2 class="onayami__heading">このような課題はありませんか？</h2>
                <ul class="onayami__list">
                  <li class="onayami__item"><span class="icon_circle_in_check"></span>今後、DXを推進するための基幹システム再構築が必要。</li>
                  <li class="onayami__item"><span class="icon_circle_in_check"></span>システムと業務内容にズレが生じたためシステム再構築が必要。</li>
                  <li class="onayami__item"><span class="icon_circle_in_check"></span>長年利用しているシステムであるため、いつ停止してもおかしくない。</li>
                  <li class="onayami__item"><span class="icon_circle_in_check"></span>基幹システムを再構築したいがイニシャルコストが高すぎる。</li>
                </ul>
              </div>
              <div class="onayami__arrow"><span></span></div>
              <div class="onayami__result">
            ...
            <section id="service" class="service js-target">
              <div class="l-section">
                <div class="service__heading">
                  <h2 class="sub__contents--title"><span class="font-mincho">サービス紹介</span></h2>
                  <p class="sub__contents--desc">
                    エイ・エヌ・エスは、中小企業様をはじめ多くのシステム再構築実績があります。<br>
                    システムの老朽化や事業発展などで、システム再構築を検討されている企業様に業務改善や管理コストの削減を実現させるご提案をします。
                  </p>
                </div>
              </div>
              <div class="service__img p-over-img"><img src="<?= $site_root; ?>assets/img/service/renewal/service_main.jpg" alt=""></div>
              <div class="l-section">
                <div class="service__cards common__cards">
                  <dl class="common__cards--list">
                    ...
                    <div class="common__cards--item -bg-gray">
                      <dt class="common__cards--dt">汎用機言語（COBOL）のシステムも対応</dt>
                      <dd class="common__cards--dd">
                        <p>オープン系/WEB系システムが増加傾向ですが、古い汎用機システムもまだまだ少なくありません。
                          当時の担当者やエンジニアが不在でソース解析が困難など諸問題を抱えてるケースがあると思いますが、 当社ではベテラン汎用機系エンジニアによりソース解析や分析、移行時のデータ移行なども対応しています。</p>
                      </dd>
                    </div><!-- ./common__cards--item -->
                  </dl>
                </div>
            ...
            <section id="features" class="features l-section js-target">
              <div class="features__inner">
                <div class="features__heading">
                  <h2 class="sub__contents--title"><span class="font-mincho">特徴</span></h2>
                  <p class="sub__contents--desc">
                ...
                <div class="common__cards">
                  <dl class="common__cards--list">
                    <div class="common__cards--item">
                      <div class="common__cards--img"><img src="<?= $site_root; ?>assets/img/service/renewal/features_img1.jpg" alt="必須機能に絞ったシステム再構築を提案"></div>
                    ...
                    <div class="common__cards--item">
                      <div class="common__cards--img"><img src="<?= $site_root; ?>assets/img/service/renewal/features_img2.jpg" alt="簡単BIツールで帳票出力"></div>
            ...
            <section id="support" class="support l-section js-target">
              <div class="support__inner">
                <div class="support__heading">
                  <h2 class="sub__contents--title"><span class="font-mincho">サポート体制</span></h2>
                  <p class="sub__contents--desc">
            ...
            <section id="flow" class="flow js-target">
              <div class=" l-section">
                <div class="flow__heading">
                  <h2 class="sub__contents--title"><span class="font-mincho">開発フロー</span></h2>
                  <p class="sub__contents--desc">
                    業績35年以上、約350社のシステム構築の実績。システム導入後も専任の保守担当者がしっかりサポートし、システム保守まで安心してお任せいただける体制をご提供いたします。
                  </p>
                </div>
              </div>
              <div class="flow__img p-over-img"><img src="<?= $site_root; ?>assets/img/service/fullorder/flow_main.jpg" alt="開発フロー"></div>
              <div class=" l-section">
                <div class="flow__service">
                  <div class="flow__service--inner">
                    <h3 class="flow__service--title">無料相談サービス</h3>
                    <dl class="flow__service--list">
                      <div class="flow__service--item">
            ...
            <section id="case" class="subCase l-section js-target">
              <div class="subCase__inner">
                <h2 class="serviceTop__mainTitle sub__contents--title"><span class="font-mincho">フルオーダーシステムの開発事例</span></h2>
            ...
            <section id="column" class="subColumn l-section js-target">
              <h2 class="serviceTop__mainTitle sub__contents--title"><span class="font-mincho">基幹システム再構築に関するコラム</span></h2>
              <div class="subColumn__inner">
                ...
                <div class="subColumn__linkButton common__linkButton"><a href=""><span class="font-mincho">全てのコラムを見る</span></a></div>
              </div>
            </section><!-- ./subColumn -->
