      ...
      <section class="sub__heading">
        <h1 class="sub__heading--text">
          <span class="sub__heading--textIn">
            <span class="font-en line-left">System Maintenance</span>
            <span class="font-mincho">システム保守引継ぎ</span>
          </span>
        </h1>
        <?php include($site_root . "_inc/headingAction.php"); ?>
        <div class="sub__headingImg"><img src="<?= $site_root; ?>assets/img/service/fullorder/heading.jpg" alt="システム保守引継ぎ"></div>
          ...
          <div class="sub__side l-column__sub">
            <div class="sub__side--in">
              ...
              <ul class="sub__side--list">
                ...
                <li class="sub__side--item js-nav"><a href="#service" class="js-anchor">システム保守引継ぎのサービス紹介</a></li>
                <li class="sub__side--item js-nav"><a href="#strong" class="js-anchor">エイ・エヌ・エスの強み</a></li>
                <li class="sub__side--item js-nav"><a href="#features" class="js-anchor">ご契約後、最短1ヶ月～保守実施が可能</a></li>
                <li class="sub__side--item js-nav"><a href="#support" class="js-anchor">サービス紹介</a></li>
                <li class="sub__side--item js-nav"><a href="#price" class="js-anchor">料金プラン</a></li>
                <li class="sub__side--item js-nav"><a href="#flow" class="js-anchor">システム保守引継ぎのフロー</a></li>
                <li class="sub__side--item js-nav"><a href="#case" class="js-anchor">システム保守引継ぎの事例</a></li>
                <li class="sub__side--item js-nav"><a href="#column" class="js-anchor">システム保守引継ぎに関するコラム</a></li>
              </ul>
            </div>
          </div>
          ...
          <div class="l-column__main maintenance">
            ...
            <section id="onayami" class="onayami l-section js-target">
              <div class="onayami__inner">
                ...
                <ul class="onayami__list">
                  <li class="onayami__item"><span class="icon_circle_in_check"></span>現在のシステム会社の保守対応が悪い、スピードが遅く運用に耐えられない</li>
                  <li class="onayami__item"><span class="icon_circle_in_check"></span>現在のシステム会社で担当者確保がむずかしくなり、保守料が高額になった</li>
                  <li class="onayami__item"><span class="icon_circle_in_check"></span>社内でシステムを維持管理(保守)する人材がいない</li>
                  <li class="onayami__item"><span class="icon_circle_in_check"></span>システムやサーバー等のインフラ管理の安全性において不安を感じている</li>
                </ul>
              </div>
              ...
              <div class="service__inner">
                <div class="service__heading">
                  ...
                  <p class="sub__contents--desc">
                    35年以上の経験で培った業務知識と技術力を活かし、現行システムの解析を通じて保守・メンテナンスサービスを提供しています。<br>
                    専属エンジニアが迅速で柔軟な対応をし、お客様のシステムを確実にサポート。これにより、お客様は本業に専念でき、安心してシステムを運用できます。
                  </p>
                </div>
              </div>
            </section>
            ...
            <section id="strong" class="strong l-section js-target">
              <div class="strong__inner">
                <h2 class="strong__title"><span class="font-mincho">エイ・エヌ・エスの強み</span></h2>
                <div class="strong__circle">
                  <dl class="strong__circle--list">
                    <div class="strong__circle--item circleItem">
            ...
            <section id="features" class="features js-target">
              <div class="features__inner">
                <div class="features__heading l-section">
                  <h2 class="sub__contents--title"><span class="font-mincho">ご契約後、最短1ヶ月～保守実施が可能</span></h2>
                </div>
                <div class="features__img p-over-img"><img src="<?= $site_root; ?>assets/img/service/maintenance/features_img.jpg" alt="開発フロー"></div>
                <div class="l-section">
            ...
            <section id="flow" class="flow js-target">
              <div class="flow__inner">
                <div class="flow__heading  l-section">
                  <h2 class="sub__contents--title"><span class="font-mincho">システム保守引継ぎのフロー</span></h2>
                  <p class="sub__contents--desc">
