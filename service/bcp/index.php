      ...
      <section class="sub__heading">
        <h1 class="sub__heading--text">
          <span class="sub__heading--textIn">
            <span class="font-en line-left">BCP</span>
            <span class="font-mincho">ITインフラのBCP対策</span>
          </span>
        </h1>
          ...
          <div class="l-column__sub">
            <div class="sub__side--in">
              ...
              <ul class="sub__side--list">
                <li class="sub__side--item js-nav"><a href="#necessity" class="js-anchor _current">BCPの必要性</a></li>
                <li class="sub__side--item js-nav"><a href="#secure" class="js-anchor">企業が取り組むべきセキュリティ対策</a></li>
                <li class="sub__side--item js-nav"><a href="#flow" class="js-anchor">BCP策定ステップ</a></li>
                <li class="sub__side--item js-nav"><a href="#plan" class="js-anchor">ITインフラBCP対策</a></li>
          ...
          <div class="l-column__main bcp">
            <div class="l-column__main--inner">
              ...
              <section id="necessity" class="l-section necessity js-target">
                <h2 class="sub__contents--title"><span class="font-mincho">BCPの必要性</span></h2>
                ...
                <div class="necessity__inner">
                  <h2 class="necessity__heading">災害や事故などの予期せぬ出来事の例</h2>
                  <ul class="necessity__list">
                    <li class="necessity__item">
                ...
                <div class="necessity__arrow"><span></span></div>
                <div class="necessity__result">
              ...
              <!-- #secure -->
              <section id="secure" class="l-section secure js-target">
                <div class="secure__heading">
                  <h2 class="sub__contents--title"><span class="font-mincho">企業が取り組むべきセキュリティ対策</span></h2>
                  <p class="sub__contents--desc">
                ...
                <div class="secure__inner">
                  <div class="secure__img p-over-img"><img src="<?= $site_root; ?>assets/img/service/bcp/secure_img.jpg" alt="企業が取り組むべきセキュリティ対策"></div>

                  <div class="secure__cards">
                    <dl class="common__cards--list secure__cards--list">
                      <div class="common__cards--item secure__cards--item">
              ...
              <section id="flow" class="l-section flow js-target">
                <div class="flow__inner">
                  <div class="flow__heading">
                    <h2 class="sub__contents--title"><span class="font-mincho">BCP策定ステップ</span></h2>
                    <p class="sub__contents--desc">
              ...
              <section id="plan" class="l-section plan js-target">
                <div class="plan__inner">
                  <div class="plan__heading">
                    <h2 class="sub__contents--title"><span class="font-mincho">ITインフラBCP対策</span></h2>
                  </div>
                  <div class="plan__cards">
                    <dl class="plan__cards--list">
                      <div class="plan__cards--item">
                      ...
                      <div class="plan__cards--item _reverse">
