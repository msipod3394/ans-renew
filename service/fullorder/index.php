      ...
      <section class="sub__heading">
        <h1 class="sub__heading--text">
          <span class="sub__heading--textIn">
            <span class="font-en line-left">FullOrder</span>
            <span class="font-mincho">フルオーダーシステム開発</span>
          </span>
        </h1>
        <?php include($site_root . "_inc/headingAction.php"); ?>
        <div class="sub__headingImg"><img src="<?= $site_root; ?>assets/img/service/fullorder/heading.jpg" alt=""></div>
        ...
        <div class="l-column">
          <div class="sub__side l-column__sub">
            <div class="sub__side--in">
              ...
              <ul class="sub__side--list">
                ...
                <li class="sub__side--item js-nav"><a href="#service" class="js-anchor">フルオーダーシステム開発のサービス紹介</a></li>
                <li class="sub__side--item js-nav"><a href="#price" class="js-anchor">フルオーダーシステム開発の料金プラン</a></li>
                <li class="sub__side--item js-nav"><a href="#support" class="js-anchor">フルオーダーシステム開発のサポート体制</a></li>
                <li class="sub__side--item js-nav"><a href="#develop" class="js-anchor">フルオーダーシステム開発の開発体制</a></li>
                <li class="sub__side--item js-nav"><a href="#flow" class="js-anchor">フルオーダーシステム開発の開発フロー</a></li>
                <li class="sub__side--item js-nav"><a href="#case" class="js-anchor">フルオーダーシステム開発の事例</a></li>
                <li class="sub__side--item js-nav"><a href="#column" class="js-anchor">フルオーダーシステム開発に関するコラム</a></li>
              </ul>
            </div>
          </div>
          <!--./l-column__sub-->
          ...
          <div class="l-column__main">
            ...
            <section id="onayami" class="onayami l-section js-target">
              <div class="onayami__inner">
                ...
                <ul class="onayami__list">
                  <li class="onayami__item"><span class="icon_circle_in_check"></span>中小企業向けのシステムを、オーダーメイドで開発してくれる会社がない。</li>
                  <li class="onayami__item"><span class="icon_circle_in_check"></span>パッケージシステムでは自社の運用に合わず、管理できる機能がない。</li>
                  <li class="onayami__item"><span class="icon_circle_in_check"></span>売上の基礎をつくる自社独自の業務に合わせたシステムを開発したい。</li>
                </ul>
              </div>
            ...
            <section id="service" class="service js-target">
              ...
              <div class="service__img p-over-img"><img src="<?= $site_root; ?>assets/img/service/fullorder/sercive_main.jpg" alt=""></div>
              <div class="l-section">
                <div class="service__cards common__cards">
                  <dl class="common__cards--list">
                    ...
                    <div class="common__cards--item">
                      ...
                      <dd class="common__cards--dd">
                        <p>使い心地にこだわった、誰でも簡単に操作できるストレスのないシステムを構築。
            ...
            <section id="develop" class="develop l-section js-target">
              <div class="develop__inner">
                <div class="develop__heading">
                  <h2 class="sub__contents--title"><span class="font-mincho">開発体制</span></h2>
                  <p class="sub__contents--desc">
            ...
            <section id="flow" class="flow js-target">
              ...
              <div class="flow__img"><img src="<?= $site_root; ?>assets/img/service/fullorder/flow_main.jpg" alt=""></div>
              <div class="l-section">
                <dl class="flow__list">
            ...
            <section id="column" class="subColumn l-section js-target">
              <h2 class="serviceTop__mainTitle sub__contents--title"><span class="font-mincho">フルオーダーシステムに関するコラム</span></h2>
