    ...
    <main class="sub__container company company__sub">
      ...
      <section class="sub__heading">
        <h1 class="sub__heading--text">
          <span class="sub__heading--textIn">
            <span class="font-en line-left">Outline / Access</span>
            <span class="font-mincho">会社概要 / アクセス</span>
          </span>
        </h1>
      ...
      <div id="outline" class="l-block company__sub--contents outline">
        <div class="l-column__main outline__main">
          ...
          <!-- #outline-contents -->
          <section id="outline-contents" class="l-section js-target outline__contents">
            <h2 class="sub__contents--title"><span class="font-mincho">会社概要</span></h2>
            <div class="outline__contents--list">
              <dl class="contentsList">
                <div class="contentsList__item">
                ...
                <div class="contentsList__item">
                  ...
                  <dd class="contentsList__dd">
                    <a href="" target="_blank" class="contentsList__dd--link">
                ...
                <div class="contentsList__item">
                  ...
                  <dd class="contentsList__dd">
                    1989年（平成元年）12月1日<br>
                    <img src="<?= $site_root; ?>assets/img/company/outline/bnr_35th.jpg" alt="株式会社エイ・エヌ・エスは、創立35周年を迎えました。">
                  </dd>
                </div>
                <div class="contentsList__item">
          ...
          <!-- #outline-access -->
          <section id="outline-access" class="l-section js-target outline__access">
            <h2 class="sub__contents--title"><span class="font-mincho">アクセス</span></h2>
            <div class="outline__access--list">
              ...
              <div class="outline__access--info">
                <dl>
