      ...
      <section class="sub__heading">
        <h1 class="sub__heading--text">
          <span class="sub__heading--textIn">
            <span class="font-en line-left">Company</span>
            <span class="font-mincho">会社情報</span>
          </span>
        </h1>
        <?php include($site_root . "_inc/headingAction.php"); ?>
        <div class="sub__headingImg"><img src="<?= $site_root; ?>assets/img/company/top/heading.jpg" alt="会社情報"></div>
      ...
      <div id="companyTop" class="l-block company__sub--contents">
        <div class="companyTop__section">
          <div class="companyTop__section--left">
            <h2 class="companyTop__section--heading sub__contents--subtitle">
            ...
            <p class="companyTop__section--text">
            ...
            <div class="companyTop__section--link c-btn-circle">
          ...
          <div class="companyTop__section--right"><img src="<?= $site_root; ?>assets/img/company/top/philosophy.jpg" alt="企業理念" loading="lazy"></div>
        ...
        <div class="companyTop__section -reverse">
          ...
          <div class="companyTop__section--right"><img src="<?= $site_root; ?>assets/img/company/topmessage/topmessage_ceo.jpg" loading="lazy"></div>
        </div><!-- ./companyTop__section -->
      </div><!-- ./l-block -->

      <div class="companyTop__otherLink otherLink">
