      ...
      <section class="sub__heading js-subHeading-show">
        <h1 class="sub__heading--text">
          <span class="sub__heading--textIn">
            <span class="font-en line-left text-progress" data-txt="<?= $page_title ?>"><?= $page_title ?></span>
            <span class="font-mincho text-progress" data-txt="<?= $page_title ?>"><?= $page_title ?></span>
          </span>
        </h1>
        <?php include($site_root . "_inc/headingAction.php"); ?>
        <div class="sub__headingImg"><img src="<?= $site_root; ?>assets/img/usability/heading.jpg?<?= time() ?>" alt="UI/UX"></div>
        ...
        <div class="l-column">
          ...
          <div class="l-column__sub">
            <div class="sub__side--in js-ani-fade">
              ...
              <ul class="sub__side--list">
                <li class="sub__side--item js-nav"><a href="#about" class="js-anchor"><span>UI/UXデザインを業務システムに取り入れる</span></a></li>
          ...
          <div class="l-column__main usability">
            ...
            <section id="about" class="about l-section js-target">
              ...
              <dl class="about__cards--tagsdl">
                <div class="about__cards--tags">
                  <dt class="about__cards--tagdt js-ani-fade">使い心地の良い業務システムのデザインとは</dt>
                  <dd class="about__cards--tagdd js-ani-fade">
                    <ul class="about__cards--tagList">
                      <li class="about__cards--tagItem  js-ani-fade"><span>シンプルで直感的なデザイン</span>UIは直感的な操作ができ、情報や機能が簡単に見つかるように設計されるべきです。</li>
                      <li class="about__cards--tagItem  js-ani-fade"><span>一貫性のあるデザイン要素</span>ユーザーがより認識しやすくするため、デザイン要素は一貫性、統一感が重要です。</li>
                      <li class="about__cards--tagItem  js-ani-fade"><span>素早いレスポンスと高速な読込時間</span>短い読み込み時間と素早い操作レスポンスがユーザーエクスペリエンスに重要です。</li>
                      <li class="about__cards--tagItem  js-ani-fade"><span>分かりやすいナビゲーション</span>ユーザーがアプリ内を簡単に移動できるよう分かりやすいナビゲーションが重要です。</li>
                      <li class="about__cards--tagItem  js-ani-fade"><span>適切なフィードバック</span>アクションに対する明確で分かりやすいフィードバックが重要です。</li>
                      <li class="about__cards--tagItem  js-ani-fade"><span>モバイルフレンドリー</span>モバイル対応により、レスポンシブデザインやモバイルアプリ最適化が重要です。</li>
                      <li class="about__cards--tagItem  js-ani-fade"><span>ユーザーフィードバックの取り入れ</span>ユーザーの利用方法を理解し、フィードバックを活用して改善することが大切です。</li>
                      <li class="about__cards--tagItem  js-ani-fade"><span>アクセシビリティの考慮</span>多様なユーザーに対応し、利用しやすい環境を提供します。</li>
                    </ul>
                  </dd>
                </div>
              </dl>
            ...
            <section id="features" class="features l-section js-target">
              <div class="features__inner">
                <div class="features__heading">
                  <h2 class="sub__contents--title js-ani-fade"><span class="font-mincho">私たちにできること</span></h2>
                  <p class="sub__contents--desc js-ani-fade">
                ...
                <div class="common__cards">
                  <dl class="common__cards--list">
                    <div class="common__cards--item js-ani-fade">
                      <div class="common__cards--img"><img src="<?= $site_root; ?>assets/img/usability/features_1.jpg" alt="ユーザー主体設計" loading="lazy"></div>
                      <dt class="common__cards--dt _hasObi">ユーザー主体設計</dt>
                    ...
                    <div class="common__cards--item js-ani-fade">
                      <div class="common__cards--img"><img src="<?= $site_root; ?>assets/img/usability/features_2.jpg" alt="UI / UX" loading="lazy"></div>
                      <dt class="common__cards--dt _hasObi">UI / UX</dt>
                      <dd class="common__cards--dd">
                        <p>
            ...
            <section id="userneeds" class="userneeds js-target">
              <div class="userneeds__inner l-section">
                <div class="userneeds__heading">
                  <h2 class="sub__contents--title js-ani-fade"><span class="font-mincho">ユーザーニーズ遷移をデザインする</span></h2>
                  <p class="sub__contents--desc js-ani-fade">
                ...
                <div class="userneeds__figure">
                  <div class="userneeds__figure--top figureTop js-ani-fade">
                  ...
                  <div class="userneeds__figure--arrow icon-arrow3 js-ani-fade"></div>
                  <div class="userneeds__figure--bottom figureBottom js-ani-fade">
            ...
            <section id="cases" class="cases l-section js-target">
              <div class="cases__inner">
                <div class="cases__heading">
                  <h2 class="sub__contents--title js-ani-fade"><span class="font-mincho">業務システムUI/UX改善事例</span></h2>
                  <p class="sub__contents--desc js-ani-fade">
                ...
                <div class="cases__cards">
                  <ul class="cases__cards--list">
                    <li class="cases__cards--item  js-ani-fade">
                      <h3 class="cases__cards--title"><span class="title-obi">共通のメニュー画面から、<br class="sp">ユーザー毎のメニュー画面へ</span></h3>
                      <div class="cases__cards--itemIn">
                        <div class="cases__cards--itemBox itemBox _before">
                          ...
                          <div class="itemBox__img"><img src="<?= $site_root; ?>assets/img/usability/cases_before.jpg" alt="Before" loading="lazy"></div>
                        ...
                        <div class="cases__cards--itemBox itemBox _after">
                          ...
                          <div class="itemBox__img"><img src="<?= $site_root; ?>assets/img/usability/cases_after.jpg" alt="After" loading="lazy"></div>
                          <p class="itemBox__desc">
            ...
            <section id="uiux" class="uiux js-target">
              ...
              <div class="uiux__img p-over-img js-ani-fade-ho"><img src="<?= $site_root; ?>assets/img/ittrust/uiux.jpg" alt="使い心地を追求したUI/UXデザイン" loading="lazy"></div>
              <div class="uiux__prosess l-section">
                <h3 class="sub__contents--subtitle js-ani-fade"><span>エイ・エヌ・エスのシステム開発プロセス</span></h3>
                <div class="uiux__prosess--img js-ani-fade"><img src="<?= $site_root; ?>assets/img/ittrust/uiux_prosess.jpg" alt="エイ・エヌ・エスのシステム開発プロセス" loading="lazy"></div>
              ...
              <div class="uiux__mockup l-section">
                <h3 class="sub__contents--subtitle js-ani-fade"><span>モックアップの作成とは？</span></h3>
                <p class="sub__contents--desc js-ani-fade">
                ...
                <dl class="uiux__mockup--list">
                  <div class="uiux__mockup--item js-ani-fade">
                    ...
                    <img src="<?= $site_root; ?>assets/img/usability/mockup_1.jpg" alt="モックアップ画面を作成" loading="lazy">
                  </div>
                  <div class="uiux__mockup--arrows js-ani-fade"><span class="icon-arrows"></span></div>
                  <div class="uiux__mockup--item js-ani-fade">
                    ...
                    <img src="<?= $site_root; ?>assets/img/usability/mockup_2.jpg" alt="モックアップ画面を作成" loading="lazy">
                  </div>
                </dl>
                <div class="uiux__mockup--arrow js-ani-fade"><span class="icon-arrow3"></span></div>
                <div class="uiux__mockup--result js-ani-fade"><span class="c-color-orange">認識の相違なく、システム導入が可能</span></div>
              </div>
              <div class="uiux__point l-section">
                <h3 class="sub__contents--subtitle js-ani-fade"><span>モックアップ作成のポイント</span></h3>
                <p class="sub__contents--desc js-ani-fade">
                  要件定義の段階で実際に操作感を確認できるモックアップを作成します。<br>
                  <span class="c-text-border">
                    開発・導入前にシステムのデザイン、操作感を画面上で確認できるため、認識の相違なく、システム導入を進めることができます。
                ...
                <div class="uiux__point--cards">
                  <dl class="uiux__point--cards--list">
                    <div class="uiux__point--cards--item js-ani-fade">
                      <div class="uiux__point--cards--img"><img src="<?= $site_root; ?>assets/img/usability/uiux_point_1.jpg" alt="関連業務の特性と全体像を掴み、効率と使いやすさを両立させる" loading="lazy"></div>
                    ...
                    <div class="uiux__point--cards--item _reverse">
                      <div class="uiux__point--cards--img"><img src="<?= $site_root; ?>assets/img/usability/uiux_point_2.jpg" alt="複雑な機能を持つ業務システムに、体験の一貫性を持たせる" loading="lazy"></div>
                      <div class="uiux__point--cards--contents">
                    ...
                    <div class="uiux__point--cards--item js-ani-fade">
                      <div class="uiux__point--cards--img"><img src="<?= $site_root; ?>assets/img/usability/uiux_point_3.jpg" alt="利用者視点からの業務システム設計" loading="lazy"></div>
                      <div class="uiux__point--cards--contents">
            ...
            <section id="column" class="subColumn js-target">
              <div class="subColumn__inner l-section">
                <h2 class="serviceTop__mainTitle sub__contents--title js-ani-fade"><span class="font-mincho">システム開発に関するコラム</span></h2>
